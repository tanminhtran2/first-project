...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname,$host,$username,$password)
{
      ...
      $smtp_host =$host;//Dia chi mail server
      $admin_email =   $username;//User duoc khai bao tren mail server
      $smtp_username = $username;//User duoc khai bao tren mail server
      $smtp_password = $password;//Pass cua email nay
